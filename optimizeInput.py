...
class Repressor:
    """
    This class contains the parameters and output functions to represent a biological repressor.
    ...
    def __init__(self, name, ymax, ymin, K, n):
        """Inits Repressor with its name, ymax, ymin, the K_d, and the slope factor."""
        self.name = name
        self.ymax = ymax
        self.ymin = ymin
        self.K = K
...
class Input: 
    """
    This class contains the parameters to represent an input promoter in the context of a biological circuit.

    The class provides methods to get the output of the given input, as well as modify the input
    through DNA and protein engineering operations.
